...
for(var i=0;i<playerArrows.length;i++) {
  ...
  var baseCollision = Matter.SAT.collides(playerArrows[i].body,
    ...
    var archerCollision = Matter.SAT.collides(playerArrows[i].body,
      computerArcher.body);

      var computerCollision = Matter.SAT.collides(playerArrows[i].body,
        computer.body);
...
function handleComputerArrowCollision() {
  ...
  for(var x=0;x<playerArrows.length;x++) {
    ...
    var baseCollision = Matter.SAT.collides(computerArrows[x].body,
      ...
      var archerCollision = Matter.SAT.collides(computerArrows[x].body,
        playerArcher.body);
  
        var playerCollision = Matter.SAT.collides(computerArrows[x].body,
          player.body);
